		...
		<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-10">
						<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i> VUN <span>> Sesiones por pantalla</span></h1>
					</div>
				...
				/* BASIC ;*/
					...
					$("#dt_basic").jqGrid({
						colModel: [
							{
								//label: ' ',
								name: 'PantallaReconocida',
								width: 50//,
								//formatter: formatTitle
							},
							{
								//label: 'Accion Reconocida',
								name: 'AccionReconocida',
								width: 40,
							...
							{
								//label: 'Accion Reconocida',
								name: 'avgAffectedUsersCrashes',
								width: 40,
								align: 'center',
								search: false,
								sorttype:'integer',
								formatter: formatColor2
								//formatter: formatLink
							} /*,	
							{
								//label: 'Launches',
					...
					function fetchGridData(startdate,finishdate,appID, appName) {
						...
						$.ajax({
							url: "apppulse_sesiones_pantalla.php?startdate=" + startdate + "&finishdate=" + finishdate + "&appID=" + appID,
							success: function (result) {
								...
								for (var i = 0; i < result[0].data.length; i++) {
									...
									gridArrayData.push({
										PantallaReconocida: item.PantallaReconocida,
										AccionReconocida: item.AccionReconocida,
										averageHits: item.averageHits,
										avgAffectedUsersCrashes : item.avgAffectedUsersCrashes
									});
					...
					$("#export").on("click", function(){
						$("#dt_basic").jqGrid("exportToExcel",{
							...
							includeFooter: true,
							fileName : "sesiones_pantalla.xlsx",
					...
					fetchGridData(ayer_str,hoy_str,'2ac2d3f7d5f54969a55987908d5600cd',"Santander SmartBank Android");
					/* bar chart */
