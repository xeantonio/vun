		...
		<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i> VUN <span>> Consumo de Recursos</span></h1>
					</div>
							...
							<div class="jarviswidget" id="wid-id-2" data-widget-editbutton="false">
								...
								<div>
									...
									<div class="widget-body no-padding">
										<br>
										<h1 id="titulo" class="bg-color-darken txt-color-white"></h2>
										<h5 class="bg-color-darken txt-color-white padding-10>Por tipo de conexi&oacute;n</h6>
										<div id="pie-chart" class="chart"></div>
										<h5 class="bg-color-darken txt-color-white padding-10">Uso Bater&iacute;a</h6>
										<div id="bar-bateria" class="chart"></div>
										<h5 class="bg-color-darken txt-color-white padding-10">Uso Datos</h6>
			...
			function onDataReceivedBarsDispositivo(series) {
				...
				for(i=0;i<series.length;i++){
					...
					for(j=0;j<aux.length;j++){
						...
						battery.push([aux[j].timestamp,aux[j].batteryUsage]);
				...
				$.plot("#bar-bateria", [{
					...
					label: "Santander Mobile Android - Batería",
					bars: {
							show: true,
							barWidth: 0.2,
							align: "right"
					...
					label: "Santander SmartBank Android - Batería",
					bars: {
							show: true,
							barWidth: 0.2,
							align: "center"
					...
					label: "Santander SmartBank iOS - Batería",
					bars: {
							show: true,
							barWidth: 0.2,
							align: "left"
				...
				$.plot("#bar-datos", [{
					...
					tooltip : true,
					tooltipOpts : {
						content : "<b>%s</b> : <span>%y Bytes</span>",
						dateFormat : "%d-%m-%y %H:%M",
						defaultTheme : false
					},
					xaxis: {
