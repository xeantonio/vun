...
if (isset($_SESSION["nombrecompleto"])){
	...
	<div id="main" role="main">
		...
		<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-10">
						<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i> VUN <span>> Accesos totales</span></h1>
					</div>
						...
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="jarviswidget" id="wid-id-2" data-widget-editbutton="false">
								...
								<header class="bg-color-darken txt-color-white">
									...
									<h2>ACCESOS TOTALES DE USUARIOS</h2>
								...
								<div>
									...
									<div class="widget-body no-padding">
										<br>
										<h4 id="titulo" class="bg-color-darken txt-color-white padding-10">  </h4>
										<br>
										<h2 class="alert"><strong>Por Versi&oacute;n</strong></h2>
										<div id="bar-version" class="chart"></div>
										<br>
										<h2 class="alert"><strong>Por Dispositivo</strong></h2>
		...
		<script>
			...
			getBarsDispositivo(ayer_str,hoy_str, 'd56e9149845747158bd778736c096366',"Santander SmartBank iOS");
			...
			function getBarsVersion(startdate,finishdate,appID, appName){
				...
				$.ajax({
					...
					type: "GET",
					dataType: "json",
					url: "apppulse_accesos_diarios_version.php",
				})
			...
			function getBarsDispositivo(startdate,finishdate,appID, appName){
				...
				$.ajax({
					...
					type: "GET",
					dataType: "json",
					url: "apppulse_accesos_diarios_dispositivo.php",
				})
				.done(function( data, textStatus, jqXHR ) {
					//console.log("mis datos:",data);
					if(data.length > 1){
			...
			function onDataReceivedBarsVersion(series) {
				...
				for(i=0;i<series.length;i++){
					...
					for(j=0;j<aux.length;j++){
						...
						version.push([aux[j].versionName,aux[j].numberOfUsers]);
			...
			function onDataReceivedBarsDispositivo(series) {
				...
				for(i=0;i<series.length;i++){
					...
					for(j=0;j<aux.length;j++){
						...
						//fundex.push([aux[j].timestamp,aux[j].fundex]);
						var labelpaso= aux[j].deviceName;
						var labelpaso2 = labelpaso.replace(" ","<br>");
						var labelpaso3= labelpaso2.replace(" ","<br>");
						dispositivo.push([labelpaso3,aux[j].numberOfUniqueUsers]);
